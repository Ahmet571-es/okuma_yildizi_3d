...
export const CURRICULUM = {
  ...
  L: {
    ...
    words: ['at','et','it','al','el','il','an','ne','in','alt','tat','tan','ten','net','tin','lal',
            'tane','nane','nine','lale','alet','elle','elli','ileti','anlatı','anti','inat','telli'],
  ...
  O: {
    ...
    words: ['ol','on','ot','not','ton','tol','otel','nota','talon','anlatı','anol','oltan'],
  ...
  K: {
    ...
    words: ['kale','kol','kel','kan','kin','kot','tek','tok','oktan','kalite',
            'kanal','keten','kilit','kolon','kinet','tokat','kanat','aktöl','tekne','kettle'],
  ...
  U: {
    ...
    words: ['un','kul','tuz','kutu','unut','ulak','kulon','nutuk','kulak','kukla','tutun','kutu','tuluk'],
  ...
  R: {
    ...
    words: ['arı','renk','arka','rota','tür','tur','kar','rol','rulo',
            'kurt','orta','tire','rant','kural','ortak','kartal','kulüt','kornet'],
  ...
  M: {
    ...
    words: ['mum','mal','men','mola','marul','makine','minik','motor','mutlu',
            'metin','mental','market','milk','miktar','malum','mıntık','milat'],
